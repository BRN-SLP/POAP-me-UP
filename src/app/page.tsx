        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="flex-1 flex flex-col items-center justify-center px-4 py-32 text-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-5xl mx-auto space-y-10">
                    <h1 className="text-7xl md:text-9xl font-heading font-bold tracking-tighter text-white leading-[0.9]">
                        POAP me <span className="text-gradient-base">UP</span>
                    </h1>

                    <p className="text-xl md:text-3xl text-white/60 max-w-3xl mx-auto leading-relaxed font-light">
...
function FeatureCard({
    ...
    return (
        <div className={`glass-panel p-10 rounded-[2rem] hover:bg-white/[0.08] transition-all duration-500 group border border-white/5 ${borderColor} ${glowColor}`}>
