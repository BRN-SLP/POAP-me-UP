...
declare const createWireFlow: <TOmniGraph extends OmniGraph>({ logger, executeConfig, signAndSend, }: CreateWireFlowArgs<TOmniGraph>) => ({ graph, assert, dryRun, skipConnectionsFromEids, }: WireFlowArgs<TOmniGraph>) => Promise<SignAndSendResult>;
