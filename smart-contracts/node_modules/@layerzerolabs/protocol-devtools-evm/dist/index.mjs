...
import { AsyncRetriable, AddressSchema, ignoreZero, formatEid, isZero, isDeepEqual, compareBytes32Ascending, areBytes32Equal, formatOmniPoint } from '@layerzerolabs/devtools';
import { BigNumberishBigIntSchema, BigNumberishNumberSchema, OmniSDK, makeZeroAddress, addChecksum } from '@layerzerolabs/devtools-evm';
import { printJson, printBoolean } from '@layerzerolabs/io-devtools';
import { DVNDstConfigSchema as DVNDstConfigSchema$1, Uln302UlnConfigSchema as Uln302UlnConfigSchema$1, Uln302ExecutorConfigSchema as Uln302ExecutorConfigSchema$1, ExecutorDstConfigPre2_1_27Schema as ExecutorDstConfigPre2_1_27Schema$1, ExecutorDstConfigPost2_1_27Schema as ExecutorDstConfigPost2_1_27Schema$1, PriceDataSchema as PriceDataSchema$1, UlnReadUlnConfigSchema, TimeoutSchema } from '@layerzerolabs/protocol-devtools';
...
var DVNDstConfigSchema = DVNDstConfigSchema$1.extend({
  gas: BigNumberishBigIntSchema,
  multiplierBps: BigNumberishBigIntSchema,
  floorMarginUSD: BigNumberishBigIntSchema
});

// ../../node_modules/.pnpm/@layerzerolabs+lz-evm-sdk-v2@3.0.75/node_modules/@layerzerolabs/lz-evm-sdk-v2/artifacts/contracts/uln/dvn/DVN.sol/DVN.json
var abi = [
  {
    inputs: [
      {
...
// src/dvn/factory.ts
var createDVNFactory = (providerFactory) => pMemoize(async (point) => new DVN(await providerFactory(point.eid), point));
var Uln302UlnConfigSchema = Uln302UlnConfigSchema$1.extend({
  confirmations: BigNumberishBigIntSchema,
  optionalDVNThreshold: z.number(),
  requiredDVNCount: z.number()
});
var Uln302ExecutorConfigSchema = Uln302ExecutorConfigSchema$1.extend({
  maxMessageSize: BigNumberishNumberSchema
});

// ../../node_modules/.pnpm/@layerzerolabs+lz-evm-sdk-v2@3.0.75/node_modules/@layerzerolabs/lz-evm-sdk-v2/artifacts/contracts/uln/uln302/SendUln302.sol/SendUln302.json
var abi2 = [
  {
    inputs: [
      {
...
// src/uln302/sdk.ts
var NIL_DVN_COUNT = (1 << 8) - 1;
var Uln302 = class extends OmniSDK {
  constructor(provider, point) {
    super({ eid: point.eid, contract: new Contract(point.address, abi2).connect(provider) });
  }
  async getUlnConfig(eid, address, type) {
    ...
    const parsed = {
      ...
      optionalDVNThreshold: (_a = config.optionalDVNThreshold) != null ? _a : 0
    };
  ...
  encodeExecutorConfig(config) {
    ...
    return assert3(typeof encoded === "string", "Must be a string"), encoded;
  }
  decodeUlnConfig(ulnConfigBytes) {
    ...
    const parsed = {
      ...
      optionalDVNThreshold: (_a = rtnConfig.optionalDVNThreshold) != null ? _a : 0
    };
    return Uln302UlnConfigSchema.parse(parsed);
  }
...
var createUln302Factory = (providerFactory) => pMemoize(async (point) => new Uln302(await providerFactory(point.eid), point));
var BlockedUln302 = class extends Uln302 {
  async getAppUlnConfig(eid, address, _type) {
    this.logger.verbose(
    ...
    return {
      ...
      // type(uint8).max indicates blocked
    };
  }
  /**
   * @see {@link IUln302.hasAppUlnConfig}
   */
  async hasAppUlnConfig(eid, oapp, _config, type) {
    this.logger.verbose(
  ...
  async getUlnConfig(eid, address, _type) {
    this.logger.verbose(
      `Returning blocked config for ULN configs for eid ${eid} (${formatEid(eid)}) and OApp ${address} because the message library is BlockedMessageLib`
    );
    return {
   ...
   * @see {@link IUln302.hasAppExecutorConfig}
   */
  async hasAppExecutorConfig(eid, oapp, _config) {
    this.logger.debug(
...
__decorateClass([
  AsyncRetriable()
], BlockedUln302.prototype, "getAppUlnConfig", 1);
__decorateClass([
  AsyncRetriable()
], BlockedUln302.prototype, "getUlnConfig", 1);
__decorateClass([
  AsyncRetriable()
], BlockedUln302.prototype, "getAppExecutorConfig", 1);
__decorateClass([
  AsyncRetriable()
], BlockedUln302.prototype, "getExecutorConfig", 1);
var ReceiveLibrarySchema = z.tuple([AddressSchema.transform(ignoreZero), z.boolean()]);

// ../../node_modules/.pnpm/@layerzerolabs+lz-evm-sdk-v2@3.0.75/node_modules/@layerzerolabs/lz-evm-sdk-v2/artifacts/contracts/EndpointV2.sol/EndpointV2.json
var abi3 = [
  {
    inputs: [
      {
...
// ../../node_modules/.pnpm/@layerzerolabs+lz-evm-sdk-v2@3.0.75/node_modules/@layerzerolabs/lz-evm-sdk-v2/artifacts/contracts/uln/readlib/ReadLib1002.sol/ReadLib1002.json
var abi4 = [
  {
    inputs: [
      {
...
// src/ulnRead/sdk.ts
var NIL_DVN_COUNT2 = (1 << 8) - 1;
var UlnRead = class extends OmniSDK {
  constructor(provider, point) {
    super({ eid: point.eid, contract: new Contract(point.address, abi4).connect(provider) });
  }
  ...
  serializeUlnConfig({
    ...
    return {
      executor,
      requiredDVNCount: requiredDVNs.length > 0 ? requiredDVNs.length : NIL_DVN_COUNT2,
      optionalDVNCount: optionalDVNs.length,
      optionalDVNThreshold,
      requiredDVNs: requiredDVNs.map(addChecksum).sort(compareBytes32Ascending),
      optionalDVNs: optionalDVNs.map(addChecksum).sort(compareBytes32Ascending)
...
var createUlnReadFactory = (providerFactory) => pMemoize(async (point) => new UlnRead(await providerFactory(point.eid), point));
...
var EndpointV2 = class extends OmniSDK {
  constructor(provider, point) {
    super({ eid: point.eid, contract: new Contract(point.address, abi3).connect(provider) });
  }
  ...
  async getUln302SDK(address) {
    ...
    if (await this.isBlockedLibrary(address)) {
      return new BlockedUln302(this.contract.contract.provider, { eid: this.point.eid, address });
    }
  ...
  async isBlockedLibrary(uln) {
    assert3(!isZero(this.contract.contract.address), "EndpointV2 can not be zero");
    try {
...
var createEndpointV2Factory = (providerFactory) => pMemoize(async (point) => new EndpointV2(await providerFactory(point.eid), point));
var ExecutorDstConfigPre2_1_27Schema = ExecutorDstConfigPre2_1_27Schema$1.extend({
  baseGas: BigNumberishBigIntSchema,
  multiplierBps: BigNumberishBigIntSchema,
  floorMarginUSD: BigNumberishBigIntSchema,
  nativeCap: BigNumberishBigIntSchema
});
var ExecutorDstConfigPost2_1_27Schema = ExecutorDstConfigPost2_1_27Schema$1.extend({
...
// ../../node_modules/.pnpm/@layerzerolabs+lz-evm-sdk-v2@3.0.75/node_modules/@layerzerolabs/lz-evm-sdk-v2/artifacts/contracts/Executor.sol/Executor.json
var abi5 = [
  {
    inputs: [
      {
...
var Executor = class extends OmniSDK {
  constructor(provider, point) {
    super({ eid: point.eid, contract: new Contract(point.address, abi5).connect(provider) });
  }
  async getDstConfig(eid) {
    const config = await this.contract.contract.dstConfig(eid);
...
var createExecutorFactory = (providerFactory) => pMemoize(async (point) => new Executor(await providerFactory(point.eid), point));
var PriceDataSchema = PriceDataSchema$1.extend({
  priceRatio: BigNumberishBigIntSchema,
  gasPriceInUnit: BigNumberishBigIntSchema,
  gasPerByte: BigNumberishBigIntSchema
});

// ../../node_modules/.pnpm/@layerzerolabs+lz-evm-sdk-v2@3.0.75/node_modules/@layerzerolabs/lz-evm-sdk-v2/artifacts/contracts/PriceFeed.sol/PriceFeed.json
var abi6 = [
  {
    inputs: [
      {
...
var PriceFeed = class extends OmniSDK {
  constructor(provider, point) {
    super({ eid: point.eid, contract: new Contract(point.address, abi6).connect(provider) });
  }
  async getPrice(eid) {
...
var createPriceFeedFactory = (providerFactory) => pMemoize(async (point) => new PriceFeed(await providerFactory(point.eid), point));

export { BlockedUln302, DVN, DVNDstConfigSchema, EndpointV2, Executor, ExecutorDstConfigPost2_1_27Schema, ExecutorDstConfigPre2_1_27Schema, ExecutorDstConfigSchema, PriceDataSchema, PriceFeed, Uln302, UlnRead, createDVNFactory, createEndpointV2Factory, createExecutorFactory, createPriceFeedFactory, createUln302Factory, createUlnReadFactory };
