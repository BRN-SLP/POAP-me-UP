...
declare class Uln302 extends OmniSDK implements IUln302 {
     ...
     */
    protected serializeUlnConfig({ confirmations, requiredDVNs, requiredDVNCount, optionalDVNs, optionalDVNThreshold, }: Uln302UlnUserConfig): SerializedUln302UlnConfig;
    /**
...
declare class BlockedUln302 extends Uln302 {
    getAppUlnConfig(eid: EndpointId, address: OmniAddress, _type: Uln302ConfigType): Promise<Uln302UlnConfig>;
    /**
     * @see {@link IUln302.hasAppUlnConfig}
     */
    hasAppUlnConfig(eid: EndpointId, oapp: string, _config: Uln302UlnUserConfig, type: Uln302ConfigType): Promise<boolean>;
    /**
     * @see {@link IUln302.getUlnConfig}
     */
    getUlnConfig(eid: EndpointId, address?: OmniAddress, _type?: Uln302ConfigType): Promise<Uln302UlnConfig>;
    /**
     * @see {@link IUln302.getAppExecutorConfig}
     */
    getAppExecutorConfig(eid: EndpointId, address: OmniAddress): Promise<Uln302ExecutorConfig>;
     ...
     * @see {@link IUln302.getExecutorConfig}
     */
    getExecutorConfig(eid: EndpointId, address?: OmniAddress): Promise<Uln302ExecutorConfig>;
    /**
     * @see {@link IUln302.hasAppExecutorConfig}
     */
    hasAppExecutorConfig(eid: EndpointId, oapp: OmniAddress, _config: Uln302ExecutorConfig): Promise<boolean>;
}
