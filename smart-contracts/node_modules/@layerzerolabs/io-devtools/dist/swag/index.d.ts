 ...
 */
declare const createPenguinSpinner: (props?: PenguinSpinnerProps) => React.ReactElement<PenguinSpinnerProps>;

export { createPenguinSpinner, createProgressBar, printLogo, printRecord, printRecords, printVerticalTable };
