...
var createConfigLoader = (schema, logger2 = createModuleLogger("config loader")) => async (path$1) => {
  const absolutePath = path.resolve(path$1);
  logger2.verbose(`Resolved config file location for '${path$1}': '${absolutePath}'`);
...
exports.ERRORS_FIXES_MAP = ERRORS_FIXES_MAP;
exports.KnownErrors = KnownErrors;
exports.KnownOutputs = KnownOutputs;
exports.KnownWarnings = KnownWarnings;
exports.LogLevel = LogLevel;
exports.WARNINGS_FIXES_MAP = WARNINGS_FIXES_MAP;
