...
declare class DebugLogger {
    static keyValue(key: string, value: any, indentLevel?: number): void;
    static keyHeader(key: string, indentLevel?: number): void;
    static header(text: string): void;
    static separator(): void;
    static printErrorAndFixSuggestion(type: KnownErrors, errorMsg?: string): void;
    static printWarning(type: KnownWarnings, message?: string): void;
    static printLayerZeroOutput(type: KnownOutputs, payload?: string): void;
}
declare enum KnownErrors {
...
declare const ERRORS_FIXES_MAP: Record<KnownErrors, ErrorFixInfo>;
declare const WARNINGS_FIXES_MAP: Record<KnownWarnings, ErrorFixInfo>;

export { COLORS, type CreateWithAsyncLoggerOptions, DebugLogger, ERRORS_FIXES_MAP, KnownErrors, KnownOutputs, KnownWarnings, LogLevel, type PromptOption, WARNINGS_FIXES_MAP, createLogger, createModuleInteractionLogger, createModuleLogger, createWithAsyncLogger, handlePromptState, isLogLevel, printBoolean, printCrossTable, printJson, printRecord, printZodErrors, promptForText, promptToContinue, promptToSelectMultiple, promptToSelectOne, setDefaultLogLevel };
