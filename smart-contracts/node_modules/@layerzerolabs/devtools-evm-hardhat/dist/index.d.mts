import { A as ArtifactPackage, S as SimulationConfig, a as SimulationUserConfig } from './type-extensions-mwYcdSEm.mjs';
export { b as SimulationAnvilConfig, c as SimulationAnvilUserConfig } from './type-extensions-mwYcdSEm.mjs';
...
import { DeployOptions, DeployResult, DeploymentsExtension, Deployment } from 'hardhat-deploy/dist/types';
 ...
 */
declare function deployProxyAdmin({ hre, deployOptions, deploymentName, }: {
 ...
 */
declare function deployImplementation({ hre, deployOptions, deploymentName, }: {
    hre: HardhatRuntimeEnvironment;
    deployOptions: DeployOptions;
    deploymentName?: string;
}): Promise<DeployResult>;
 ...
 */
declare function deployProxy({ hre, deployOptions, deploymentName, }: {
    hre: HardhatRuntimeEnvironment;
    deployOptions: DeployOptions;
    deploymentName: string;
}): Promise<DeployResult>;
 ...
 */
declare function saveCombinedDeployment({ hre, deploymentName, }: {
    hre: HardhatRuntimeEnvironment;
    deploymentName: string;
}): Promise<void>;
