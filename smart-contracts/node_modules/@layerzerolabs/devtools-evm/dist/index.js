...
var GnosisOmniSignerEVM = class extends OmniSignerEVMBase {
  constructor(eid, signer, safeUrl, safeConfig, chainId, ethAdapter = new Safe.EthersAdapter({
    ethers: ethers.ethers,
    signerOrProvider: signer
  }), apiKit = new SafeApiKit__default.default({ txServiceUrl: safeUrl, apiKey: safeConfig.safeApiKey, chainId }), safeSdkPromise = Safe__default.default.create({
    ethAdapter,
