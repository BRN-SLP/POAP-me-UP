 ...
 */
declare class GnosisOmniSignerEVM<TSafeConfig extends ConnectSafeConfig & {
    safeApiKey: string;
    ...
    constructor(eid: EndpointId, signer: Signer, safeUrl: string, safeConfig: TSafeConfig, chainId: bigint, ethAdapter?: EthersAdapter, apiKit?: SafeApiKit, safeSdkPromise?: Safe | Promise<Safe>);
